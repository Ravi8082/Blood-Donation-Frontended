...
const ForgotPassword = () => {
  ...
  const handleForgotPassword = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post("https://blood-donation-backend-19.onrender.com/forgot-password", { email });
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const response = await axios.post("https://blood-donation-backend-19.onrender.com/resend-forgot-password", { email });
      setMessage(response.data);
  ...
  const handleResetPassword = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post("https://blood-donation-backend-19.onrender.com/reset-password", {
        email,
        otp: parseInt(otp),
        newPassword
      });
