...
const Registration = () => {
  ...
  const handleRegister = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post("https://blood-donation-backend-19.onrender.com/register", user);
      if (response.data) {
        setOtpSent(true);
        setError("");
  ...
  const resendOtp = async () => {
    ...
    try {
        const response = await axios.post("https://blood-donation-backend-19.onrender.com/resend-registration", {
            email: user.email,
        });
  ...
  const verifyOtp = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post("https://blood-donation-backend-19.onrender.com/verify", {
        email: user.email,
